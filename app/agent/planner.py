...
3.  **Если задача может зависеть от операционной системы (например, открытие приложений, системные команды), первым шагом всегда должна быть "Определить операционную систему".**
4.  Опиши шаги общими словами (что сделать), а не конкретными действиями (как сделать). Например, вместо "Кликнуть кнопку в координатах (500, 300)", напиши "Нажать кнопку 'Сохранить'".
5.  Последним шагом всегда должна быть проверка, что задача выполнена.
6.  Твой ответ ДОЛЖЕН быть ТОЛЬКО в формате JSON-массива строк.
